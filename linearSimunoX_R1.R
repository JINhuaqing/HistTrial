# this script is to run simulations for revision 1 for SIM
# to compare considering no subgroup effect and with subgroup effect
# My settting is 
#  alp1=1, alp2=10
# No subgroup beta0=1, beta1=0
# subgroup beta0=1, beta1=1 (no need run, same for Table~2)
#
rm(list=ls())
library(magrittr)
library(dplyr)
